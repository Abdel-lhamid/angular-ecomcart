...
export class ProductListComponent {
  ...
  allProductsCount = this.products.length;
  inStockProductsCount = this.products.filter(p => p.is_in_inventory == true).length;
  OutOfStockProductsCount = this.products.filter(p => p.is_in_inventory == false).length;
